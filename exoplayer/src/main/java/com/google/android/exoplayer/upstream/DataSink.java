...
public interface DataSink {
  ...
  /**
   * Opens the {@link com.google.android.exoplayer.upstream.DataSink} to consume the specified data. Calls to {@link #open(DataSpec)} and
   * {@link #close()} must be balanced.
   *
   * @param dataSpec Defines the data to be consumed.
   * @return This {@link com.google.android.exoplayer.upstream.DataSink}, for convenience.
   * @throws java.io.IOException
   */
  public DataSink open(DataSpec dataSpec) throws IOException;

  /**
   * Closes the {@link com.google.android.exoplayer.upstream.DataSink}.
   *
   * @throws java.io.IOException
   */
