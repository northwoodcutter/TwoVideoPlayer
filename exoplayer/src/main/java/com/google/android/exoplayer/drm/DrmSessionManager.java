...
public interface DrmSessionManager {
  ...
  /**
   * Gets a {@link android.media.MediaCrypto} for the open session.
   * <p>
   * This method may be called when the manager is in the following states:
   * {@link #STATE_OPENED}, {@link #STATE_OPENED_WITH_KEYS}
   *
   * @return A {@link android.media.MediaCrypto} for the open session.
   ...
   * <p>
   * Normally this method should return {@link android.media.MediaCrypto#requiresSecureDecoderComponent(String)},
