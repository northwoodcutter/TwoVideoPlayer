...
/**
 * Loads data from a {@link com.google.android.exoplayer.upstream.DataSource} into an in-memory {@link com.google.android.exoplayer.upstream.Allocation}. The loaded data
...
public final class DataSourceStream implements Loadable, NonBlockingInputStream {
   ...
   * @param allocator Used to obtain an {@link com.google.android.exoplayer.upstream.Allocation} for holding the data.
   */
   ...
   *
   * @return The length of the stream in bytes, or {@value com.google.android.exoplayer.upstream.DataSpec#LENGTH_UNBOUNDED} if the length
