...
public interface LoadControl {
   ...
   * @param bufferSizeContribution For controls whose {@link com.google.android.exoplayer.upstream.Allocator}s maintain a pool of memory
  ...
  /**
   * Gets the {@link com.google.android.exoplayer.upstream.Allocator} that loaders should use to obtain memory allocations into which
   * data can be loaded.
   *
   * @return The {@link com.google.android.exoplayer.upstream.Allocator} to use.
   */
   ...
   * of its allocations back to the {@link com.google.android.exoplayer.upstream.Allocator}.
   */
  void trimAllocator();
