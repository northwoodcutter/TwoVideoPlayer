...
public class HttpDataSource implements DataSource {
  ...
  /**
   * Returns the number of bytes that are still to be read for the current {@link com.google.android.exoplayer.upstream.DataSpec}. This
   * value is equivalent to {@code dataSpec.length - bytesRead()}, where dataSpec is the
   * {@link com.google.android.exoplayer.upstream.DataSpec} that was passed to the most recent call of {@link #open(com.google.android.exoplayer.upstream.DataSpec)}.
   *
