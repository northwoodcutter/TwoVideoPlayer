...
public abstract class MediaCodecTrackRenderer extends TrackRenderer {
    ...
    public MediaCodecTrackRenderer(SampleSource source, DrmSessionManager drmSessionManager,
        ...
        Log.d("TwoPlayer", "MediaCodecTrackRenderer source: ");
        this.source = source;
    ...
    protected int doPrepare() throws ExoPlaybackException {
        Log.d("TwoPlayer", "doPrepare: ");
        try {
            boolean sourcePrepared = source.prepare();
            Log.d("TwoPlayer", "sourcePrepared = " + sourcePrepared);
            if (!sourcePrepared) {
     ...
     * non-null surface.
     **/
    protected void configureCodec(MediaCodec codec, android.media.MediaFormat x,
            MediaCrypto crypto) {
    ...
    protected final void maybeInitCodec() throws ExoPlaybackException {
        ...
        try {
            ...
            DecoderInitializationException exception =
                    new DecoderInitializationException(selectedDecoderName, format, e);
    ...
    private void discardSamples(long timeUs) throws IOException, ExoPlaybackException {
        ...
        while (result == SampleSource.SAMPLE_READ && currentPositionUs <= timeUs) {
            result = source.readData(trackIndex, currentPositionUs, formatHolder, sampleHolder,
                    false);
    ...
    private void checkForDiscontinuity() throws IOException, ExoPlaybackException {
        ...
        int result =
                source.readData(trackIndex, currentPositionUs, formatHolder, sampleHolder, true);
        ...
        try {
            ...
            if (sampleEncrypted) {
                MediaCodec.CryptoInfo cryptoInfo =
                        getFrameworkCryptoInfo(sampleHolder, adaptiveReconfigurationBytes);
    ...
    private boolean drainOutputBuffer(long timeUs) throws ExoPlaybackException {
        ...
        boolean decodeOnly =
                decodeOnlyPresentationTimestamps.contains(outputBufferInfo.presentationTimeUs);
    ...
    protected abstract boolean processOutputBuffer(long timeUs, MediaCodec codec, ByteBuffer buffer,
            MediaCodec.BufferInfo bufferInfo, int bufferIndex, boolean shouldSkip) throws
