...
/**
 * A base class for {@link com.google.android.exoplayer.drm.DrmSessionManager} implementations that support streaming playbacks
 * using {@link android.media.MediaDrm}.
 */
@TargetApi(18)
public class StreamingDrmSessionManager implements DrmSessionManager {
   ...
   * @throws android.media.UnsupportedSchemeException If the specified DRM scheme is not supported.
   */
  ...
  /**
   * Provides access to {@link android.media.MediaDrm#getPropertyString(String)}.
   * <p>
  ...
  /**
   * Provides access to {@link android.media.MediaDrm#getPropertyByteArray(String)}.
   * <p>
   * This method may be called when the manager is in any state.
   *
   * @param key The key to request.
