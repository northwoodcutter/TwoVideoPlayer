...
public abstract class SegmentBase {
  ...
  /**
   * @param initialization A {@link com.google.android.exoplayer.dash.mpd.RangedUri} corresponding to initialization data, if such data
   *     exists.
  ...
  /**
   * Gets the {@link com.google.android.exoplayer.dash.mpd.RangedUri} defining the location of initialization data for a given
  ...
  public static class SegmentList extends MultiSegmentBase {
     ...
     *     segments are assumed to be of fixed duration as specified by the {@code duration}
     *     parameter.
     * @param mediaSegments A list of {@link com.google.android.exoplayer.dash.mpd.RangedUri}s indicating the locations of the segments.
     */
