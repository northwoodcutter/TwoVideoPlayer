 ...
 * {@link com.google.android.exoplayer.parser.webm.EbmlEventHandler} to define IDs/types and react to events.
 *
...
/* package */ final class DefaultEbmlReader implements EbmlReader {
  ...
  /**
   * Current {@link com.google.android.exoplayer.parser.webm.EbmlEventHandler} which is queried for element types
   ...
   * size is known and released after calling {@link com.google.android.exoplayer.parser.webm.EbmlEventHandler#onStringElement(int, String)}.
   */
   ...
   * {@link com.google.android.exoplayer.parser.webm.EbmlEventHandler#onMasterElementEnd(int)} is called.
   */
