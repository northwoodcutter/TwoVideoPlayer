...
/**
 * A {@link SampleSource} that loads media in {@link com.google.android.exoplayer.chunk.Chunk}s, which are themselves obtained from a
 * {@link com.google.android.exoplayer.chunk.ChunkSource}.
 */
public class ChunkSampleSource implements SampleSource, Loader.Listener {
  ...
  public interface EventListener {
     ...
     * @param trigger A trigger for the format selection, as specified by the {@link com.google.android.exoplayer.chunk.ChunkSource}.
  ...
  /**
   * Called when a sample has been read from a {@link com.google.android.exoplayer.chunk.MediaChunk}. Can be used to perform any
   ...
   * Resumes loading.
   * <p>
   * If the {@link com.google.android.exoplayer.chunk.ChunkSource} returns a chunk equivalent to the backed off chunk B, then the
