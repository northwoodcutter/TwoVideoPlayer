...
public class MediaCodecUtil {
  ...
  /**
   * @param profile An AVC profile constant from {@link android.media.MediaCodecInfo.CodecProfileLevel}.
   * @param level An AVC profile level from {@link android.media.MediaCodecInfo.CodecProfileLevel}.
