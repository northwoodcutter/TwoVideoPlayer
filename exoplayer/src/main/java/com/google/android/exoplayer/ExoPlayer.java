...
public interface ExoPlayer {
  ...
  public static final class Factory {
     ...
     * <p>
     * Must be invoked from a thread that has an associated {@link android.os.Looper}.
     *
  ...
  public interface ExoPlayerComponent {
     ...
     * @throws com.google.android.exoplayer.ExoPlaybackException If an error occurred whilst handling the message.
     */
  ...
  /**
   * Gets the {@link android.os.Looper} associated with the playback thread.
   *
   * @return The {@link android.os.Looper} associated with the playback thread.
   */
   ...
   * playback thread. If the component throws a {@link com.google.android.exoplayer.ExoPlaybackException}, then it is
