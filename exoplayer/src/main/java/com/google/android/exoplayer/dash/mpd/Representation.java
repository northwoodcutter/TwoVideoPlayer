...
public abstract class Representation {
   ...
   * {@link #format}'s {@link com.google.android.exoplayer.chunk.Format#id} (e.g. as a result of re-encoding the media with an
  ...
  /**
   * Gets a {@link com.google.android.exoplayer.dash.mpd.RangedUri} defining the location of the representation's initialization data.
   * May be null if no initialization data exists.
   *
   * @return A {@link com.google.android.exoplayer.dash.mpd.RangedUri} defining the location of the initialization data, or null.
   */
  ...
  /**
   * Gets a {@link com.google.android.exoplayer.dash.mpd.RangedUri} defining the location of the representation's segment index. Null if
  ...
  public static class SingleSegmentRepresentation extends Representation {
    ...
    /**
     * The {@link android.net.Uri} of the single segment.
     */
