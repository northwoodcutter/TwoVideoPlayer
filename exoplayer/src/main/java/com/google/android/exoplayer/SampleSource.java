...
public interface SampleSource {
   ...
   * {@link #readData(int, long, com.google.android.exoplayer.FormatHolder, com.google.android.exoplayer.SampleHolder, boolean)}.
   * <p>
   * This method should not be called until after the source has been successfully prepared.
   *
   ...
   * @param playbackPositionUs The current playback position.
   * @param formatHolder A {@link com.google.android.exoplayer.FormatHolder} object to populate in the case of a new format.
   * @param sampleHolder A {@link com.google.android.exoplayer.SampleHolder} object to populate in the case of a new sample. If
   *     the caller requires the sample data then it must ensure that {@link com.google.android.exoplayer.SampleHolder#data}
