...
public interface Cache {
  ...
  /**
   * Interface definition for a callback to be notified of {@link com.google.android.exoplayer.upstream.cache.Cache} events.
   */
  public interface Listener {
     ...
     * <p>
     * Note that for span replacement, {@link #onSpanAdded(com.google.android.exoplayer.upstream.cache.Cache, CacheSpan)} and
     * {@link #onSpanRemoved(com.google.android.exoplayer.upstream.cache.Cache, CacheSpan)} are not invoked in addition to this method.
     *
     * @param cache The source of the event.
   ...
   * by calling {@link #commitFile(java.io.File)}. When the caller has finished writing, it must release
