...
/**
 * An {@link com.google.android.exoplayer.upstream.Allocator} that maintains a pool of fixed length byte arrays (buffers).
 * <p>
 * An {@link com.google.android.exoplayer.upstream.Allocation} obtained from a {@link com.google.android.exoplayer.upstream.BufferPool} consists of the whole number of these
 * buffers. When an {@link com.google.android.exoplayer.upstream.Allocation} is released, the underlying buffers are returned to the pool
 * for re-use.
 */
