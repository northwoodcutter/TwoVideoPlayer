...
public interface DashSegmentIndex {
  ...
  /**
   * Returns a {@link com.google.android.exoplayer.dash.mpd.RangedUri} defining the location of a segment.
   *
   * @param segmentNum The segment number.
   * @return The {@link com.google.android.exoplayer.dash.mpd.RangedUri} defining the location of the data.
   */
