...
/**
 * A {@link com.google.android.exoplayer.upstream.DataSink} for writing to a byte array.
 */
public class ByteArrayDataSink implements DataSink {
  ...
  /**
   * Returns the data written to the sink since the last call to {@link #open(com.google.android.exoplayer.upstream.DataSpec)}.
   *
   * @return The data, or null if {@link #open(com.google.android.exoplayer.upstream.DataSpec)} has never been called.
   */
  public byte[] getData() {
