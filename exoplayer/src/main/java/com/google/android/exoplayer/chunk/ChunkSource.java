...
/**
 * A provider of {@link com.google.android.exoplayer.chunk.Chunk}s for a {@link ChunkSampleSource} to load.
 */
/*
...
public interface ChunkSource {
  ...
  /**
   * Gets information about the track for which this instance provides {@link com.google.android.exoplayer.chunk.Chunk}s.
   * <p>
   ...
   * implementation wishes for the caller to discard {@link com.google.android.exoplayer.chunk.MediaChunk}s from the queue), together
   * with the next {@link com.google.android.exoplayer.chunk.Chunk} to load. The next chunk may be a {@link com.google.android.exoplayer.chunk.MediaChunk} to be added to
   * the queue, or another {@link com.google.android.exoplayer.chunk.Chunk} type (e.g. to load initialization data), or null if the
   ...
   *     initially equal to null or a {@link com.google.android.exoplayer.chunk.Chunk} previously supplied by the {@link com.google.android.exoplayer.chunk.ChunkSource}
