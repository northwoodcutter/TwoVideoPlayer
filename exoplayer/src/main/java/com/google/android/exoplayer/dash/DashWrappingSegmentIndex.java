...
/**
 * An implementation of {@link com.google.android.exoplayer.dash.DashSegmentIndex} that wraps a {@link SegmentIndex} parsed from a
 * media stream.
 */
public class DashWrappingSegmentIndex implements DashSegmentIndex {
   ...
   * @param uri The {@link android.net.Uri} where the data is located.
