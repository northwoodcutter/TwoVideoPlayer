...
/* package */ interface EbmlEventHandler {
   ...
   *
   * <p>If {@link com.google.android.exoplayer.parser.webm.EbmlReader#TYPE_UNKNOWN} is returned then the element is skipped.
   ...
   *
   * <p>Several methods in {@link com.google.android.exoplayer.parser.webm.EbmlReader} are available for reading the contents of a
   * binary element:
   * <ul>
   * <li>{@link com.google.android.exoplayer.parser.webm.EbmlReader#readVarint(NonBlockingInputStream)}.
   * <li>{@link com.google.android.exoplayer.parser.webm.EbmlReader#readBytes(NonBlockingInputStream, byte[], int)}.
   * <li>{@link com.google.android.exoplayer.parser.webm.EbmlReader#readBytes(NonBlockingInputStream, java.nio.ByteBuffer, int)}.
   * <li>{@link com.google.android.exoplayer.parser.webm.EbmlReader#skipBytes(NonBlockingInputStream, int)}.
   * <li>{@link com.google.android.exoplayer.parser.webm.EbmlReader#getBytesRead()}.
   * </ul>
   *
   * @param id The integer ID of this element
   * @param elementOffsetBytes The byte offset where this element starts
