...
/**
 * Concrete implementation of {@link com.google.android.exoplayer.ExoPlayer}.
 */
/* package */ final class ExoPlayerImpl implements ExoPlayer {
  ...
  /**
   * Constructs an instance. Must be invoked from a thread that has an associated {@link android.os.Looper}.
   *
