...
/**
 * Defines a range of data located at a {@link android.net.Uri}.
 */
public final class RangedUri {
  ...
  /**
   * Returns the {@link android.net.Uri} represented by the instance.
   *
   * @return The {@link android.net.Uri} represented by the instance.
   */
  public Uri getUri() {
    if (stringUri == null) {
      return baseUri;
   ...
   * <p>
   * A merge is successful if both instances define the same {@link android.net.Uri}, and if one starte the
