...
public interface DataSource {
  ...
  /**
   * Opens the {@link com.google.android.exoplayer.upstream.DataSource} to read the specified data. Calls to {@link #open(com.google.android.exoplayer.upstream.DataSpec)} and
   * {@link #close()} must be balanced.
   * <p>
   * Note: If {@link #open(com.google.android.exoplayer.upstream.DataSpec)} throws an {@link java.io.IOException}, callers must still call
   * {@link #close()} to ensure that any partial effects of the {@link #open(com.google.android.exoplayer.upstream.DataSpec)} invocation
   ...
   *     (i.e. requests where {@link com.google.android.exoplayer.upstream.DataSpec#length} equals {@link com.google.android.exoplayer.upstream.DataSpec#LENGTH_UNBOUNDED})
   *     this value is the resolved length of the request. For all other requests, the value
   *     returned will be equal to the request's {@link com.google.android.exoplayer.upstream.DataSpec#length}.
   */
