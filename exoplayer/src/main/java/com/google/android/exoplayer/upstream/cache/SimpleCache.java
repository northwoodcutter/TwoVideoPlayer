...
/**
 * A {@link com.google.android.exoplayer.upstream.cache.Cache} implementation that maintains an in-memory representation.
 */
public class SimpleCache implements Cache {
  ...
  /**
   * Returns the cache {@link com.google.android.exoplayer.upstream.cache.CacheSpan} corresponding to the provided lookup {@link com.google.android.exoplayer.upstream.cache.CacheSpan}.
   * <p>
   * If the lookup position is contained by an existing entry in the cache, then the returned
   * {@link com.google.android.exoplayer.upstream.cache.CacheSpan} defines the file in which the data is stored. If the lookup position is not
   * contained by an existing entry, then the returned {@link com.google.android.exoplayer.upstream.cache.CacheSpan} defines the maximum extents
   * of the hole in the cache.
   *
   * @param lookupSpan A lookup {@link com.google.android.exoplayer.upstream.cache.CacheSpan} specifying a key and position.
   * @return The corresponding cache {@link com.google.android.exoplayer.upstream.cache.CacheSpan}.
   */
