 ...
 *
 * <p>Internally, a renderer's lifecycle is managed by the owning {@link com.google.android.exoplayer.ExoPlayer}. The player
...
public abstract class TrackRenderer implements ExoPlayerComponent {
   ...
   * @throws com.google.android.exoplayer.ExoPlaybackException If an error occurs.
   */
   ...
   *     {@link com.google.android.exoplayer.ExoPlaybackException} is thrown).
   */
   ...
   *     (unless a {@link com.google.android.exoplayer.ExoPlaybackException} is thrown).
   * @throws com.google.android.exoplayer.ExoPlaybackException If an error occurs.
   */
  ...
  /**
   * Whether the renderer is ready for the {@link com.google.android.exoplayer.ExoPlayer} instance to transition to
   * {@link com.google.android.exoplayer.ExoPlayer#STATE_ENDED}. The player will make this transition as soon as {@code true} is
